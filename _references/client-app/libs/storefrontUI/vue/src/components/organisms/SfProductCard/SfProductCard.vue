      ...
      <SfButton
        ...
        <slot name="wishlist-icon" v-bind="{ currentWishlistIcon }">
          <SfIcon
            ...
            size="22px"
            data-test="sf-wishlist-icon"></SfIcon>
        </slot>
      </SfButton>
...
<script>
import { colorsValues as SF_COLORS } from "@core/variables/colors";
...
<style lang="scss">
@import "assets/styles/scss/components/organisms/SfProductCard.scss";
</style>
