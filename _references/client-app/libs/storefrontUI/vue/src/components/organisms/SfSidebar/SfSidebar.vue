<template>
  <div class="sf-sidebar" :class="[staticClass, className]">
    <SfOverlay :visible="visibleOverlay"></SfOverlay>
        ...
        <div v-if="title || hasTop" class="sf-sidebar__top">
          ...
          <slot name="title" v-bind="{ title, subtitle, headingLevel }">
            <SfHeading
              ...
              :level="headingLevel"
              class="sf-heading--left sf-heading--no-underline sf-sidebar__title desktop-only"></SfHeading>
          </slot>
...
<style lang="scss">
@import "assets/styles/scss/components/organisms/SfSidebar.scss";
</style>
