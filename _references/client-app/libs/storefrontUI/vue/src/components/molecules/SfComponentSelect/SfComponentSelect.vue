<template>
  <div
    ...
    <div style="position: relative;">
      ...
      <slot name="icon">
        <SfChevron class="sf-component-select__chevron"></SfChevron>
      </slot>
      <SfOverlay
        ref="overlay"
        :visible="open"
        class="sf-component-select__overlay smartphone-only"></SfOverlay>
...
<script>
import Vue from "vue";
import { focus , clickOutside } from "../../../utilities/directives";
...
<style lang="scss">
@import "assets/styles/scss/components/molecules/SfComponentSelect.scss";
</style>
