    ...
    <slot name="prev" v-bind="{ isDisabled: !canGoPrev, go, prev: getPrev }">
      <div class="sf-pagination__item prev">
        <component
          ...
          <SfIcon icon="arrow_left" size="1.125rem"></SfIcon>
        </component>
      </div>
    </slot>
    ...
    <slot name="next" v-bind="{ isDisabled: !canGoNext, go, next: getNext }">
      <div class="sf-pagination__item next">
        <component
          ...
          <SfIcon icon="arrow_right" size="1.125rem"></SfIcon>
        </component>
      </div>
    </slot>
  </nav>
...
<style lang="scss">
@import "assets/styles/scss/components/molecules/SfPagination.scss";
</style>
