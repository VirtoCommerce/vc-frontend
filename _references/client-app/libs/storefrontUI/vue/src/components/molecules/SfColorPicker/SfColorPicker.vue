  ...
  <div class="sf-color-picker" :class="{ 'sf-color-picker--active': isOpen }">
    <transition name="sf-color-picker" mode="out-in">
      ...
      <div v-else
           ...
           class="sf-color-picker__colors">
        <SfOverlay
          :visible="isOpen"
          class="sf-color-picker__colors__overlay smartphone-only"></SfOverlay>
...
<style lang="scss">
@import "assets/styles/scss/components/molecules/SfColorPicker.scss";
</style>
