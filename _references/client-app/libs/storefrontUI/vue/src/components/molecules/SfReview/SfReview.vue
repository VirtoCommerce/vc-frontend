    ...
    <slot name="info" v-bind="{ rating, maxRating, date }">
      <div class="sf-review__info">
        <div :class="{ 'sf-review__rating': rating > 0 && maxRating > 0 }">
          <SfRating v-if="rating"
                    :max="maxRating"
                    :score="rating"></SfRating>
        </div>
...
<style lang="scss">
@import "assets/styles/scss/components/molecules/SfReview.scss";
</style>
