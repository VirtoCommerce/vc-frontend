    ...
    <slot name="active">
      <li>
        <SfButton
          ...
          class="sf-button--pure sf-bullet is-active"></SfButton>
      </li>
    </slot>
      ...
      <slot
        ...
        <li :key="inactiveLeft + 1 + index">
          <SfButton
            ...
            @click="go(inactiveLeft + 1 + index)"></SfButton>
        </li>
      </slot>
    </template>
  </ol>
...
<style lang="scss">
@import "assets/styles/scss/components/atoms/SfBullets.scss";
</style>
