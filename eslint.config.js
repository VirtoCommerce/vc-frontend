...
export default defineConfigWithVueTs(
  ...
  // Type-aware configuration for test files
  {
    ...
    languageOptions: {
      parserOptions: {
        projectService: {
          defaultProject: tsconfigs.vitest,
        },
        tsconfigRootDir,
      },
    },
  ...
  // Configuration for Storybook files
  {
    ...
    languageOptions: {
      parserOptions: {
        projectService: {
          defaultProject: tsconfigs.storybook,
        },
        tsconfigRootDir,
      },
    },
  ...
  // Type-aware configuration for examples files
  {
    ...
    languageOptions: {
      parserOptions: {
        projectService: {
          defaultProject: tsconfigs.examples,
        },
        tsconfigRootDir,
      },
    },
