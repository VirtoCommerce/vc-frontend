...
export type NewsArticlesQuery = { newsArticles?: { totalCount?: number, items?: Array<{ id: string, title?: string, publishDate?: any, contentPreview?: string, content?: string, tags?: Array<string>, author?: { id: string, name?: string, iconUrl?: string }, seoInfo: { semanticUrl: string } }> } };
