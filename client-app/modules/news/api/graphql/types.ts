...
export type NewsArticlesQuery = { newsArticles?: { totalCount?: number, items?: Array<{ id: string, title?: string, publishDate?: any, content?: string, contentPreview?: string, seoInfo: { semanticUrl: string } }> } };
