...
export type CancelReturnMutation = { cancelReturn?: { id: string, number: string, status?: string, cancelReason?: string } };
...
export type SubmitReturnMutation = { submitReturn?: { id: string, number: string, status?: string } };
...
export type GetReturnsQuery = { returns?: { totalCount?: number, items?: Array<{ id: string, number: string, status?: string, createdDate: any, orderId?: string, itemsQuantity: number }> } };
