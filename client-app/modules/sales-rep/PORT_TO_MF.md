...
| `createWrapperFactory` from `@/core/utilities/tests` (5 specs)                                                                                                        | `@vc-frontend/core/testing` — ships as real source, since a plugin's specs run with no host to inject anything                                                                                                                                                                                                         |
