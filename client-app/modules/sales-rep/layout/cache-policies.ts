...
import type { InMemoryCache, TypePolicies } from "@apollo/client/core";
...
export function registerLayoutTypePolicies(cache: InMemoryCache): void {
  cache.policies.addTypePolicies(layoutTypePolicies);
}
