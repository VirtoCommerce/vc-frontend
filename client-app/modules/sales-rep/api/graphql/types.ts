...
export type Query = {
  ...
  salesRepActivities?: Maybe<SalesRepActivityConnection>;
  salesRepCartFilterRules?: Maybe<Array<Maybe<SalesRepCartFilterRule>>>;
  salesRepCustomer?: Maybe<SalesRepCustomerDetails>;
  salesRepCustomerActivitySummary?: Maybe<SalesRepCustomerActivitySummary>;
  ...
  salesRepCustomerInsights?: Maybe<SalesRepCustomerInsights>;
...
export type QuerySalesRepActivitiesArgs = {
...
export type QuerySalesRepCustomerActivitySummaryArgs = {
  cultureName?: InputMaybe<Scalars['String']['input']>;
  organizationId: Scalars['String']['input'];
  period?: InputMaybe<SalesRepStatisticsPeriodInput>;
  storeId?: InputMaybe<Scalars['String']['input']>;
...
export type QuerySalesRepCustomerInsightsArgs = {
  cultureName?: InputMaybe<Scalars['String']['input']>;
  organizationId?: InputMaybe<Scalars['String']['input']>;
  period?: InputMaybe<SalesRepStatisticsPeriodInput>;
  storeId?: InputMaybe<Scalars['String']['input']>;
...
export type SalesRepActivityCategoryCount = {
  /** Activity category (orders, customers, searches, productViews, logins). */
  category: Scalars['String']['output'];
  /** Total number of activity rows in this category for the applied filters. */
  count: Scalars['Int']['output'];
};
...
export type SalesRepActivityConnection = {
  ...
  /** Total number of activity rows matching the filters (across all requested categories). */
  totalCount: Scalars['Int']['output'];
};

export type SalesRepActivityEvent = {
  /** Activity category: orders | customers | searches | productViews | logins. */
  category: Scalars['String']['output'];
  /** Number of occurrences this row aggregates (>1 for analytics hour-buckets). */
  count?: Maybe<Scalars['Int']['output']>;
  /** When the activity happened (UTC). Hour-precision rows carry the hour-bucket start. */
  occurredAt: Scalars['DateTime']['output'];
  /** Order id (orderPlaced rows). */
  orderId?: Maybe<Scalars['String']['output']>;
  /** Human-readable order number (orderPlaced rows). */
  orderNumber?: Maybe<Scalars['String']['output']>;
  orderStatus?: Maybe<Scalars['String']['output']>;
  orderStatusDisplayValue?: Maybe<Scalars['String']['output']>;
  /** Order grand total (orderPlaced rows). */
  orderTotal?: Maybe<MoneyType>;
  /** Organization (customer) id the activity belongs to. */
  organizationId?: Maybe<Scalars['String']['output']>;
  /** Organization (customer) name. */
  organizationName?: Maybe<Scalars['String']['output']>;
  /** Timestamp precision: exact | hour. */
  precision: Scalars['String']['output'];
  /** Product code as tracked by analytics (productView rows). */
  productCode?: Maybe<Scalars['String']['output']>;
  /** Resolved product id (productView rows; null when the code no longer matches a product). */
  productId?: Maybe<Scalars['String']['output']>;
  /** Product image URL (productView rows; null when unresolved). */
  productImageUrl?: Maybe<Scalars['String']['output']>;
  /** Product name (productView rows; resolved from the catalog, falling back to the tracked name). */
  productName?: Maybe<Scalars['String']['output']>;
  /** Searched phrase (search rows). */
  searchTerm?: Maybe<Scalars['String']['output']>;
  /** Activity type: orderPlaced | customerAssigned | search | productView | login. */
  type: Scalars['String']['output'];
};

export type SalesRepActivityProduct = {
  /** Product code as tracked by analytics; always present, even when the product could not be resolved. */
  code: Scalars['String']['output'];
  /** Product image URL (null when unresolved). */
  imageUrl?: Maybe<Scalars['String']['output']>;
...
export type SalesRepBrowsedProduct = {
  /** Product image URL (null when unresolved). */
  imageUrl?: Maybe<Scalars['String']['output']>;
  /** Latest tracked view, as the UTC start of an analytics hour bucket; null under sort 'count' — the aggregate rows carry no dates. */
...
export type SalesRepCustomerActivitySummary = {
  ...
  isAnalyticsAvailable: Scalars['Boolean']['output'];
  /** Most recently searched phrase (null when analytics is unavailable or has no data). */
  lastSearchTerm?: Maybe<Scalars['String']['output']>;
  /** Most recently viewed product (null when analytics is unavailable or has no data). */
...
export type SalesRepCustomerInsights = {
  /** Products the customer's users viewed, resolved from the tracked product codes. Sort 'date' aggregates a bounded page of the newest 200 hour buckets — older activity is not counted. */
  ...
  /** Whether the collections beside this are measurements: false means they are empty for want of a source, not for want of activity. Always reflects configuration, and a selected collection whose read fails turns it false as well. Asked on its own, with no collection selected, it reports configuration only — no read is made merely to test one. */
  isAnalyticsAvailable: Scalars['Boolean']['output'];
...
export type SalesRepCustomerInsightsBrowsedProductsArgs = {
  sort?: InputMaybe<Scalars['String']['input']>;
  take?: InputMaybe<Scalars['Int']['input']>;
};


export type SalesRepCustomerInsightsSearchTermsArgs = {
  sort?: InputMaybe<Scalars['String']['input']>;
  take?: InputMaybe<Scalars['Int']['input']>;
};
...
export type SalesRepSearchTerm = {
  /** Number of tracked searches for the phrase in the period. */
  count: Scalars['Int']['output'];
  /** Latest tracked search, as the UTC start of an analytics hour bucket; null under sort 'count' — the aggregate rows carry no dates. */
  lastSearchedDate?: Maybe<Scalars['DateTime']['output']>;
  /** The searched phrase. */
  term: Scalars['String']['output'];
};
...
export type SalesRepActivitiesQueryVariables = Exact<{
  organizationId?: InputMaybe<Scalars['String']['input']>;
  storeId?: InputMaybe<Scalars['String']['input']>;
  cultureName?: InputMaybe<Scalars['String']['input']>;
  ...
  take?: InputMaybe<Scalars['Int']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  withCategoryCounts?: Scalars['Boolean']['input'];
}>;


export type SalesRepActivitiesQuery = { salesRepActivities?: { isAnalyticsAvailable: boolean, totalCount: number, categoryCounts?: Array<{ category: string, count: number }>, items: Array<{ category: string, type: string, occurredAt: any, precision: string, count?: number, organizationId?: string, organizationName?: string, orderId?: string, orderNumber?: string, orderStatus?: string, orderStatusDisplayValue?: string, searchTerm?: string, productId?: string, productCode?: string, productName?: string, productImageUrl?: string, orderTotal?: { amount: number, formattedAmount: string } }> } };
...
export type SalesRepCustomerActivitySummaryQueryVariables = Exact<{
  organizationId: Scalars['String']['input'];
  storeId?: InputMaybe<Scalars['String']['input']>;
  cultureName?: InputMaybe<Scalars['String']['input']>;
  periodFrom?: InputMaybe<Scalars['DateTime']['input']>;
...
export type SalesRepCustomerActivitySummaryQuery = { salesRepCustomerActivitySummary?: { createdOn?: any, lastWebLogin?: any, visitsCount: number, lastSearchTerm?: string, isAnalyticsAvailable: boolean, lastViewedProduct?: { code: string, productId?: string, name?: string, imageUrl?: string } } };
...
export type SalesRepCustomerBrowsedProductsQueryVariables = Exact<{
  organizationId?: InputMaybe<Scalars['String']['input']>;
  storeId?: InputMaybe<Scalars['String']['input']>;
  cultureName?: InputMaybe<Scalars['String']['input']>;
  periodFrom?: InputMaybe<Scalars['DateTime']['input']>;
...
export type SalesRepCustomerSearchTermsQuery = { salesRepCustomerInsights?: { isAnalyticsAvailable: boolean, dataAsOf?: any, searchTerms: Array<{ term: string, count: number, lastSearchedDate?: any }> } };
...
export const SalesRepActivitiesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SalesRepActivities"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"categories"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"periodFrom"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"periodTo"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"take"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"skip"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"withCategoryCounts"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},"defaultValue":{"kind":"BooleanValue","value":true}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"salesRepActivities"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"organizationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}}},{"kind":"Argument","name":{"kind":"Name","value":"storeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"cultureName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}}},{"kind":"Argument","name":{"kind":"Name","value":"categories"},"value":{"kind":"Variable","name":{"kind":"Name","value":"categories"}}},{"kind":"Argument","name":{"kind":"Name","value":"period"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"from"},"value":{"kind":"Variable","name":{"kind":"Name","value":"periodFrom"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"to"},"value":{"kind":"Variable","name":{"kind":"Name","value":"periodTo"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"take"},"value":{"kind":"Variable","name":{"kind":"Name","value":"take"}}},{"kind":"Argument","name":{"kind":"Name","value":"skip"},"value":{"kind":"Variable","name":{"kind":"Name","value":"skip"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isAnalyticsAvailable"}},{"kind":"Field","name":{"kind":"Name","value":"totalCount"}},{"kind":"Field","name":{"kind":"Name","value":"categoryCounts"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"include"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"if"},"value":{"kind":"Variable","name":{"kind":"Name","value":"withCategoryCounts"}}}]}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"count"}}]}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"occurredAt"}},{"kind":"Field","name":{"kind":"Name","value":"precision"}},{"kind":"Field","name":{"kind":"Name","value":"count"}},{"kind":"Field","name":{"kind":"Name","value":"organizationId"}},{"kind":"Field","name":{"kind":"Name","value":"organizationName"}},{"kind":"Field","name":{"kind":"Name","value":"orderId"}},{"kind":"Field","name":{"kind":"Name","value":"orderNumber"}},{"kind":"Field","name":{"kind":"Name","value":"orderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"orderStatusDisplayValue"}},{"kind":"Field","name":{"kind":"Name","value":"orderTotal"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"formattedAmount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"searchTerm"}},{"kind":"Field","name":{"kind":"Name","value":"productId"}},{"kind":"Field","name":{"kind":"Name","value":"productCode"}},{"kind":"Field","name":{"kind":"Name","value":"productName"}},{"kind":"Field","name":{"kind":"Name","value":"productImageUrl"}}]}}]}}]}}]} as unknown as DocumentNode<SalesRepActivitiesQuery, SalesRepActivitiesQueryVariables>;
...
export const SalesRepCustomerActivitySummaryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SalesRepCustomerActivitySummary"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"periodFrom"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"periodTo"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"salesRepCustomerActivitySummary"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"organizationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}}},{"kind":"Argument","name":{"kind":"Name","value":"storeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"cultureName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}}},{"kind":"Argument","name":{"kind":"Name","value":"period"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"from"},"value":{"kind":"Variable","name":{"kind":"Name","value":"periodFrom"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"to"},"value":{"kind":"Variable","name":{"kind":"Name","value":"periodTo"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createdOn"}},{"kind":"Field","name":{"kind":"Name","value":"lastWebLogin"}},{"kind":"Field","name":{"kind":"Name","value":"visitsCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastSearchTerm"}},{"kind":"Field","name":{"kind":"Name","value":"isAnalyticsAvailable"}},{"kind":"Field","name":{"kind":"Name","value":"lastViewedProduct"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"productId"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}}]}}]}}]}}]} as unknown as DocumentNode<SalesRepCustomerActivitySummaryQuery, SalesRepCustomerActivitySummaryQueryVariables>;
...
export const SalesRepCustomerBrowsedProductsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SalesRepCustomerBrowsedProducts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"periodFrom"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"periodTo"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"take"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sort"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"salesRepCustomerInsights"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"organizationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}}},{"kind":"Argument","name":{"kind":"Name","value":"storeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"cultureName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}}},{"kind":"Argument","name":{"kind":"Name","value":"period"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"from"},"value":{"kind":"Variable","name":{"kind":"Name","value":"periodFrom"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"to"},"value":{"kind":"Variable","name":{"kind":"Name","value":"periodTo"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isAnalyticsAvailable"}},{"kind":"Field","name":{"kind":"Name","value":"dataAsOf"}},{"kind":"Field","name":{"kind":"Name","value":"browsedProducts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"take"},"value":{"kind":"Variable","name":{"kind":"Name","value":"take"}}},{"kind":"Argument","name":{"kind":"Name","value":"sort"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sort"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"productId"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"sku"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"viewCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastViewedDate"}}]}}]}}]}}]} as unknown as DocumentNode<SalesRepCustomerBrowsedProductsQuery, SalesRepCustomerBrowsedProductsQueryVariables>;
export const SalesRepCustomerSearchTermsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SalesRepCustomerSearchTerms"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"periodFrom"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"periodTo"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"take"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sort"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"salesRepCustomerInsights"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"organizationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}}},{"kind":"Argument","name":{"kind":"Name","value":"storeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"cultureName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}}},{"kind":"Argument","name":{"kind":"Name","value":"period"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"from"},"value":{"kind":"Variable","name":{"kind":"Name","value":"periodFrom"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"to"},"value":{"kind":"Variable","name":{"kind":"Name","value":"periodTo"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isAnalyticsAvailable"}},{"kind":"Field","name":{"kind":"Name","value":"dataAsOf"}},{"kind":"Field","name":{"kind":"Name","value":"searchTerms"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"take"},"value":{"kind":"Variable","name":{"kind":"Name","value":"take"}}},{"kind":"Argument","name":{"kind":"Name","value":"sort"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sort"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"term"}},{"kind":"Field","name":{"kind":"Name","value":"count"}},{"kind":"Field","name":{"kind":"Name","value":"lastSearchedDate"}}]}}]}}]}}]} as unknown as DocumentNode<SalesRepCustomerSearchTermsQuery, SalesRepCustomerSearchTermsQueryVariables>;
...
export const OperationNames = {
  Query: {
    ...
    SalesRepActivities: 'SalesRepActivities',
    SalesRepCustomer: 'SalesRepCustomer',
    SalesRepCustomerActivitySummary: 'SalesRepCustomerActivitySummary',
    ...
    SalesRepCustomerBrowsedProducts: 'SalesRepCustomerBrowsedProducts',
    SalesRepCustomerSearchTerms: 'SalesRepCustomerSearchTerms',
