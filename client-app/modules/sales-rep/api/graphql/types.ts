...
export type SalesRepCustomerOptionsQuery = { salesRepCustomers?: { totalCount?: number, items?: Array<{ organizationId: string, organizationName?: string, iconUrl?: string, address?: { city?: string, regionName?: string } }> } };
