...
export type SalesRepCustomerCartStatisticsQuery = { salesRepCustomerCartStatistics?: { currencyCode: string, activeCarts?: { count: number, selectedItemQuantity: number, unselectedItemQuantity: number, total: { amount: number, formattedAmount: string } }, itemsThisWeek?: { selectedItemQuantity: number } } };
