...
export type SalesRepActivityEvent = {
  ...
  /** Product SEO slug for deep-linking (productView rows; null when unresolved; resolving it requires a storeId). */
...
export type SalesRepActivityProduct = {
  ...
  productId?: Maybe<Scalars['String']['output']>;
  /** Product SEO slug for deep-linking (null when unresolved; resolving it requires a storeId). */
...
export type SalesRepCustomerActivitySummaryQuery = { salesRepCustomerActivitySummary?: { createdOn?: any, lastWebLogin?: any, visitsCount: number, lastSearchTerm?: string, isAnalyticsConfigured: boolean, lastViewedProduct?: { code: string, productId?: string, name?: string, slug?: string, imageUrl?: string } } };
...
export type SalesRepCustomerBrowsedProductsQuery = { salesRepCustomerInsights?: { dataAsOf?: any, browsedProducts: Array<{ productId: string, name?: string, sku?: string, imageUrl?: string, slug?: string, viewCount: number, lastViewedDate?: any }> } };
