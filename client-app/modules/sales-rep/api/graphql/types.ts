...
export type SalesRepDocument = {
  /** Category — the first-level subfolder of the shared library. */
...
export type SalesRepDocumentQuery = { salesRepDocument?: { id: string, name: string, category?: string, contentType?: string, size: number, createdDate: any, modifiedDate?: any, url: string, summary?: string, pageCount?: number, previewUrl?: string } };

export type SalesRepDocumentCategoriesQueryVariables = Exact<{ [key: string]: never; }>;
...
export type SalesRepDocumentsQuery = { salesRepDocuments?: { totalCount?: number, items?: Array<{ id: string, name: string, category?: string, contentType?: string, size: number, createdDate: any, modifiedDate?: any, url: string, summary?: string, pageCount?: number, previewUrl?: string }> } };
