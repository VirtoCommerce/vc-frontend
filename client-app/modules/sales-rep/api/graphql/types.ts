...
export type SalesRepCustomerCartStatisticsQuery = { salesRepCustomerCartStatistics?: { currencyCode: string, activeCarts?: { selectedItemQuantity: number, unselectedItemQuantity: number }, itemsThisWeek?: { selectedItemQuantity: number } } };
