...
export type SalesRepBrowsedProduct = {
  /** Product image URL (null when unresolved). */
  imageUrl?: Maybe<Scalars['String']['output']>;
  /** Latest tracked view (UTC hour-bucket start); null under sort 'count' — the aggregate rows carry no dates. */
...
export type SalesRepCustomerActivitySummary = {
  ...
  /** Whether analytics is available and configured for the store; false means the analytics figures carry no data. */
  isAnalyticsConfigured: Scalars['Boolean']['output'];
  ...
  /** Most recently viewed product (null when analytics is not configured or has no data). */
  lastViewedProduct?: Maybe<SalesRepActivityProduct>;
  /** Last tracked storefront login (UTC hour-bucket start; null when analytics is not configured or has no data). */
...
export type SalesRepSearchTerm = {
  ...
  count: Scalars['Int']['output'];
  /** Latest tracked search (UTC hour-bucket start); null under sort 'count' — the aggregate rows carry no dates. */
...
export type SalesRepCustomerActivitySummaryQuery = { salesRepCustomerActivitySummary?: { createdOn?: any, lastWebLogin?: any, visitsCount: number, lastSearchTerm?: string, isAnalyticsConfigured: boolean, lastViewedProduct?: { code: string, productId?: string, name?: string, imageUrl?: string } } };
...
export type SalesRepCustomerBrowsedProductsQuery = { salesRepCustomerInsights?: { dataAsOf?: any, browsedProducts: Array<{ productId: string, name?: string, sku?: string, imageUrl?: string, viewCount: number, lastViewedDate?: any }> } };
...
export type SalesRepCustomerSearchTermsQuery = { salesRepCustomerInsights?: { dataAsOf?: any, searchTerms: Array<{ term: string, count: number, lastSearchedDate?: any }> } };
