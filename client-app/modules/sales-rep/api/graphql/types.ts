...
export type SalesRepCustomerSortRule = {
  ...
  localizedName?: Maybe<Scalars['String']['output']>;
  /** Stable sort-rule id — send it back as the salesRepCustomers 'sort' argument. */
  name: Scalars['String']['output'];
};
...
export type SalesRepOrderSortRule = {
  /** Localized label for the ordering. */
  localizedName?: Maybe<Scalars['String']['output']>;
  /** Stable sort-rule id — send it back as the salesRepOrders 'sort' argument. */
  name: Scalars['String']['output'];
};
...
export type SalesRepTopSellerSortRule = {
  /** Localized label for the ordering. */
  localizedName?: Maybe<Scalars['String']['output']>;
  /** Stable sort-rule id — send it back as the salesRepTopSellers 'sort' argument. */
  name: Scalars['String']['output'];
};
...
export type SalesRepCartFilterRulesQueryVariables = Exact<{
  storeId?: InputMaybe<Scalars['String']['input']>;
  cultureName?: InputMaybe<Scalars['String']['input']>;
}>;


export type SalesRepCartFilterRulesQuery = { salesRepCartFilterRules?: Array<{ name: string, localizedName?: string }> };
...
export type SalesRepCustomerCartStatisticsQuery = { salesRepCustomerCartStatistics?: { currencyCode: string, activeCarts?: { count: number, lastCartDate?: any, total: { amount: number, formattedAmount: string } }, newCartsThisWeek?: { count: number } } };
...
export type SalesRepCustomerCountsQuery = { salesRepCustomerCounts?: { assignedCustomers: number, thisMonth?: { orderingCustomers: number, newCustomers: number }, monthOverMonth?: { orderingCustomersChange: number, orderingCustomersChangePercent?: number, newCustomersChange: number, newCustomersChangePercent?: number } } };
...
export type SalesRepCustomerSortRulesQuery = { salesRepCustomerSortRules?: Array<{ name: string, localizedName?: string }> };
...
export type SalesRepOrderSortRulesQuery = { salesRepOrderSortRules?: Array<{ name: string, localizedName?: string }> };
...
export type SalesRepOrdersQuery = { salesRepOrders?: { totalCount?: number, items?: Array<{ id: string, number?: string, organizationId?: string, organizationName?: string, createdDate: any, status?: string, statusDisplayValue?: string, itemsCount: number, itemsQuantity: number, total: { amount: number, formattedAmount: string, currency: { code: string, symbol: string } } }> } };
...
export type SalesRepTopSellerSortRulesQuery = { salesRepTopSellerSortRules?: Array<{ name: string, localizedName?: string }> };
...
export const SalesRepCartFilterRulesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SalesRepCartFilterRules"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"salesRepCartFilterRules"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"storeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"storeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"cultureName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cultureName"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"localizedName"}}]}}]}}]} as unknown as DocumentNode<SalesRepCartFilterRulesQuery, SalesRepCartFilterRulesQueryVariables>;
...
export const OperationNames = {
  Query: {
    ...
    SalesRepCartFilterRules: 'SalesRepCartFilterRules',
