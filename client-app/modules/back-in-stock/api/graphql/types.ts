...
export type ActivateBackInStockSubscriptionMutation = { activateBackInStockSubscription?: { id: string, storeId: string, isActive: boolean, productId: string } };
...
export type DeactivateBackInStockSubscriptionMutation = { deactivateBackInStockSubscription?: { id: string, storeId: string, isActive: boolean, productId: string } };
...
export type GetBackInStockSubscriptionsQuery = { backInStockSubscriptions?: { totalCount?: number, items?: Array<{ id: string, isActive: boolean, productId: string, storeId: string }> } };
