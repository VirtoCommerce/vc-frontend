...
export type LoyaltyUserMission = {
  ...
  /** The accumulated value as money in the goal currency. Null when the goal has no currency (non-OrderValue goals). */
  ...
  /** The target value as money in the goal currency. Null when the goal has no currency (non-OrderValue goals). */
...
export type GetLoyaltyMissionProgressQuery = { loyaltyMissionProgress?: { totalCount?: number, items?: Array<{ missionId?: string, progressId?: string, name?: string, localizedName?: string, description?: string, bannerUrl?: string, missionType?: string, status?: string, isStarted?: boolean, percentage?: number, currentValue?: number, targetValue?: number, startDate?: any, endDate?: any, periodStart?: any, periodEnd?: any, completedDate?: any, daysRemaining?: number, currentMoneyValue?: { formattedAmount: string }, targetMoneyValue?: { formattedAmount: string }, rewardPoints?: { amount: number }, items?: Array<{ productId?: string, currentQuantity: number, targetQuantity: number, product?: { id: string, name: string, code: string, slug?: string, imgSrc?: any, minQuantity?: number, maxQuantity?: number, packSize: number, availabilityData: { isActive: boolean, isAvailable: boolean, isBuyable: boolean, isInStock: boolean, availableQuantity: number }, price: { actual: { amount: number, formattedAmount: string, currency: { code: string } } } } }> }>, pageInfo: { hasNextPage: boolean, endCursor?: string } } };
