...
export type PurchaseRequestFragment = { id: string, number: string, cartId?: string, quoteId?: string, sources: Array<{ name: string, url: string, contentType: string, size: number }> };
...
export type UpdatePurchaseRequestByDocumentsMutation = { updatePurchaseRequestByDocuments?: { id: string, number: string, cartId?: string, quoteId?: string, sources: Array<{ name: string, url: string, contentType: string, size: number }> } };
