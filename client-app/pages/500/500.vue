    ...
    <div class="mx-auto w-3/5 pt-5 pb-32">
      <div class="flex justify-between gap-16">
        <div class="flex flex-col py-12">
          <h1 class="text-black-800 text-7xl md:text-8xl font-black mb-5 font-lato">500</h1>
          <h2 class="text-black-800 text-2xl md:text-4xl font-bold mb-2 font-lato">Internal Server Error</h2>
        ...
        <div class="hidden md:block py-5">
          <img src="/assets/static/images/500.png" alt="Internal Server Error" class="max-w-md" />
        </div>
      </div>
    </div>
  </div>
