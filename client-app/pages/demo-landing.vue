<template>
  <div class="pt-7">
    <div class="w-full max-w-screen-2xl mx-auto pb-5 lg:pb-10 px-5 md:px-12">
      ...
      <h1 v-t="'pages.demo_landing.header'" class="font-bold text-gray-900 text-3xl lg:text-4xl uppercase"></h1>
    </div>
    ...
    <div class="bg-white py-10 lg:py-24">
      <div class="w-full max-w-screen-xl mx-auto px-14 lg:px-32">
        ...
        ></div>
        <div v-t="'pages.demo_landing.secondary_block.secondary_text'" class="text-base text-center"></div>
      </div>
    </div>
    ...
    <div class="bg-gray-100 py-10 lg:py-24">
      <div class="w-full max-w-screen-xl mx-auto px-5 md:px-12">
        ...
        ></div>
        <div v-t="'pages.demo_landing.features_block.secondary_text'" class="text-base text-center"></div>
    ...
    <div class="bg-white py-10 lg:py-24">
      <div class="w-full max-w-screen-xl mx-auto px-14 lg:px-32">
        <div
          ...
          class="font-bold text-2xl lg:text-4xl mb-6 text-center"
        ></div>
        <div v-t="'pages.demo_landing.after_products_block.secondary_text'" class="text-base text-center"></div>
      </div>
    </div>
