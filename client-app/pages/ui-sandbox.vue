<template>
  <VcContainer>
    <VcLayout sidebar-position="right" sticky-sidebar>
      <VcWidget title="Orders">
        <VcTable :columns="columns" :items="items" description="Orders table">
        ...
        <div class="mt-4 flex flex-col gap-4 md:mt-0">
          <VcWidget title="Summary">
            <div class="flex flex-col gap-3">
              <VcLabel>Price</VcLabel>
              <VcTypography tag="div" class="text-lg font-bold">{{ n(sidebarTotal, "currency") }}</VcTypography>

              <div class="mt-2 grid grid-cols-2 gap-3">
                <VcButton color="primary" variant="solid" @click="onBuy">Buy</VcButton>
                <VcButton color="neutral" variant="outline" @click="onCancel">Cancel</VcButton>
              </div>
...
const columns = [
  ...
  { id: "quantity", title: "Quantity", align: "right" as const },
  { id: "total", title: "Total", align: "right" as const },
];
