<template>
  <div id="thank-you">
    <SfCallToAction
      ...
      :image="{
        mobile: '/themes/assets/static/thank-you/bannerM.png',
        desktop: '/themes/assets/static/thank-you/bannerD.png',
      }">
...
<script>
import { SfHeading, SfButton, SfCallToAction } from '@libs/storefrontUI/vue';
export default {
  components: {
    SfHeading,
    SfButton,
