  ...
  <div class="container mx-auto w-4/5 py-5">
    <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-24">
      <div class="my-8 px-4">
        ...
        <div class="flex space-x-3 px-3 py-2.5 h-11 bg-red-50 rounded-sm">
        ...
        <div class="mt-4">
          ...
          <input type="text" placeholder="User Name" class="border h-11 border-gray-300 rounded px-3 py-1 w-full" />
        </div>
        <div class="mt-4">
          <span class="font-semibold" for>Password</span>
          <span class="text-red-500">*</span>
          <input type="password" placeholder="Password" class="border h-11 border-gray-300 rounded px-3 py-1 w-full" />
        </div>
