      ...
      <div class="w-full max-w-screen-xl mx-auto px-5 md:px-12">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-20 gap-y-10 items-center mt-16 px-8 lg:px-0">
          <div class="text-center">
            <VcImage src="/static/images/demo-landing/feat-1.svg" class="h-24 mx-auto mb-9" is-lazy />
            <div
          ...
          <div class="text-center">
            <VcImage src="/static/images/demo-landing/feat-2.svg" class="h-24 mx-auto mb-9" is-lazy />
            <div
              class="font-roboto-condensed uppercase font-bold text-2xl mb-3"
          ...
          <div class="text-center">
            <VcImage src="/static/images/demo-landing/feat-3.svg" class="h-24 mx-auto mb-9" is-lazy />
            <div
              class="font-roboto-condensed uppercase font-bold text-2xl mb-3"
