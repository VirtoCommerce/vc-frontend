<template>
  ...
  <div class="header hidden lg:block">
    ...
    <div class="relative">
      <div class="px-12 py-7 flex items-center justify-between bg-white">
        <router-link to="/"><Image src="/static/images/common/logo.svg" class="h-12" /></router-link>
      ...
      >
        <router-link to="/" @click="searchVisible = false">
          <Image src="/static/images/common/logo-white.svg" class="h-12" />
        </router-link>
        <input
  ...
  <div class="lg:hidden fixed z-10 bg-white w-full border-b shadow-md">
    <div class="px-6 flex justify-between items-center h-14">
      <router-link to="/"><Image src="/static/images/common/logo.svg" class="h-9" /></router-link>
