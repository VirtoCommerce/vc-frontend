  ...
  <div class="relative">
    ...
    >
      ...
      <a
        ...
        :href="catalogLink"
        type="button"
        class="border-primary flex select-none items-center rounded border-2 px-[0.8rem] py-[0.55rem] text-sm text-[color:var(--color-header-bottom-link)] hover:text-[color:var(--color-header-bottom-link-hover)]"
