<template>
  <VcModal variant="success" :title="$t('shared.account.profile_update_success_modal.title')" is-persistent>
    ...
    <div class="flex items-center justify-center gap-4 px-5 py-10">
      ...
      <span v-t="'shared.account.profile_update_success_modal.message'" class="text-lg"></span>
    </div>
  </VcModal>
</template>
