  ...
  <VcWidget :title="$t(`shared.catalog.product_details.price_block.title`)">
    ...
    <template #footer-container>
      <div class="flex select-none divide-x print:hidden">
        <AddToList class="w-1/5" :product="product" tooltip-placement="bottom" custom-class="size-5" />

        <AddToCompareCatalog class="w-1/5" :product="product" tooltip-placement="bottom" custom-class="size-5" />
