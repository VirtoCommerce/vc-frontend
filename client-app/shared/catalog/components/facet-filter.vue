<template>
  <VcFilterCard is-collapsible :title="facet.label" :is-collapsed="!filterHasSelectedValues(facet)">
...
const filterHasSelectedValues = (f: FacetItemType) => f.values.some((value) => value.selected);
</script>
