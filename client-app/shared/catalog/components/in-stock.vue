<template>
  <VcChip v-if="isDigital" size="sm" variant="outline-dark" color="info" rounded>
    {{ $t("common.labels.digital_product") }}
  </VcChip>

  <VcChip v-else-if="isInStock" size="sm" variant="outline-dark" color="success" rounded>
  ...
  <VcChip v-else-if="!isAvailable" size="sm" variant="outline-dark" color="danger" rounded>
    {{ $t("common.messages.product_no_longer_available") }}
  </VcChip>

  <VcChip v-else size="sm" variant="outline-dark" color="danger" rounded>
