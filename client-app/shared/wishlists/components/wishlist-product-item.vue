<template>
  <div class="flex items-center gap-x-8 pb-5 py-3 px-6">
    ...
    <div
      ...
      class="relative shrink-0 w-full flex-1 flex space-x-3 items-center"
    >
    ...
    <!-- Price -->
    <div :class="{ 'opacity-25': !productAvailable }" class="shrink-0 w-32 text-sm flex flex-col items-start">
