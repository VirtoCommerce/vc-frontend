...
export function _useNavigations() {
  ...
  // `priority` is intentionally not applied: mobile prepends in registration order (desktop is the
  // priority-ordered path — see AccountNavigationSectionType.priority).
