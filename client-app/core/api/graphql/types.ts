...
export type GetPurchaseRequestQuery = { purchaseRequest?: { id: string, number: string, cartId: string, sources: Array<{ name: string, url: string, contentType: string, size: number }> } };
