...
export type GetRecentlyBrowsedQuery = { recentlyBrowsed?: { products?: Array<{ id: string, name: string, code: string, hasVariations: boolean, imgSrc?: string, minQuantity?: number, maxQuantity?: number, vendor?: { name: string }, availabilityData: { availableQuantity: number, isInStock: boolean }, price: { actual: { amount: number, formattedAmount: string }, list: { amount: number, formattedAmount: string } }, minVariationPrice?: { actual: { amount: number, formattedAmount: string }, list: { amount: number, formattedAmount: string } } }> } };
