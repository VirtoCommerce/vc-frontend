...
export type SearchProductsQuery = { products?: { totalCount?: number, items?: Array<{ name: string, id: string, code: string, minQuantity?: number, maxQuantity?: number, slug?: string, outline?: string, imgSrc?: string, variations?: Array<{ id?: string }>, images?: Array<{ url?: string }>, description?: { content: string, id: string, languageCode: string, reviewType: string }, availabilityData?: { isActive?: boolean, isAvailable?: boolean, isBuyable?: boolean, isInStock?: boolean, availableQuantity: any }, price?: { actual?: { amount: any, formattedAmount: string }, discountAmount?: { amount: any, formattedAmount: string }, sale?: { amount: any, formattedAmount: string }, list?: { amount: any, formattedAmount: string } } }>, term_facets?: Array<{ name: string, terms?: Array<{ term?: string, count?: any, isSelected?: boolean }> }>, range_facets?: Array<{ name: string, ranges?: Array<{ label?: string, count?: any, from?: any, to?: any, isSelected?: boolean }> }> } };
