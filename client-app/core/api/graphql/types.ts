...
export type ConfirmEmailMutation = { confirmEmail?: { succeeded: boolean, errors?: Array<{ code: string, parameter?: string, description?: string }> } };

export type ErrorsFragment = { code: string, parameter?: string, description?: string };
...
export const ErrorsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"errors"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"IdentityErrorInfoType"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"parameter"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]} as unknown as DocumentNode<ErrorsFragment, unknown>;
