...
export type Mutations = {
  ...
  createPurchaseRequestFromDocument?: Maybe<Scalars['Boolean']['output']>;
...
export type CreatePurchaseRequestFromDocumentMutation = { createPurchaseRequestFromDocument?: boolean };
