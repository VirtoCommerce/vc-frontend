...
export type PropertyFragment = { name: string, value?: string | number | boolean | null, propertyType: PropertyType, hidden: boolean, propertyValueType: PropertyValueTypes, label: string };
...
export type GetFcmSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetFcmSettingsQuery = { fcmSettings?: { apiKey: string, authDomain: string, projectId: string, storageBucket: string, messagingSenderId: string, appId: string, vapidKey: string } };
...
export const GetFcmSettingsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetFcmSettings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"fcmSettings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"apiKey"}},{"kind":"Field","name":{"kind":"Name","value":"authDomain"}},{"kind":"Field","name":{"kind":"Name","value":"projectId"}},{"kind":"Field","name":{"kind":"Name","value":"storageBucket"}},{"kind":"Field","name":{"kind":"Name","value":"messagingSenderId"}},{"kind":"Field","name":{"kind":"Name","value":"appId"}},{"kind":"Field","name":{"kind":"Name","value":"vapidKey"}}]}}]}}]} as unknown as DocumentNode<GetFcmSettingsQuery, GetFcmSettingsQueryVariables>;
