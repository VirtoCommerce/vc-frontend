...
export type ShortOrderFieldsFragment = { id: string, number: string, createdDate: any, status?: string };
...
export type GetShortOrderQuery = { order?: { id: string, number: string, createdDate: any, status?: string } };
