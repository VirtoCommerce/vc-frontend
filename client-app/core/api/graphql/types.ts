...
export type PropertyFragment = { id: string, name: string, value?: any, type: string, hidden: boolean, valueId?: string, valueType: string, label: string };
