...
export type GetPushMessagesQuery = { pushMessages?: { totalCount?: number, unreadCount: number, items?: Array<{ id: string, createdDate: any, shortMessage: string, isRead: boolean }> } };
