...
export type GetProductQuery = { product?: { name: string, id: string, code: string, slug?: string, outline?: string, hasVariations: boolean, minQuantity?: number, maxQuantity?: number, imgSrc?: string, inWishlist: boolean, productType?: string, associations?: { totalCount?: number }, images: Array<{ url: string }>, assets: Array<{ id: string, name?: string, url: string, size: number, mimeType?: string }>, breadcrumbs: Array<{ itemId: string, typeName: string, title: string, seoPath?: string }>, description?: { content?: string }, properties: Array<{ name: string, value?: string | number | boolean | null, propertyType: PropertyType, hidden: boolean, propertyValueType: PropertyValueTypes, label: string, displayOrder?: number }>, variations: Array<{ id: string, name: string, minQuantity?: number, maxQuantity?: number, code: string, productType?: string, images: Array<{ url: string }>, properties: Array<{ name: string, value?: string | number | boolean | null, propertyType: PropertyType, hidden: boolean, propertyValueType: PropertyValueTypes, label: string, displayOrder?: number }>, vendor?: { id: string, name: string, rating?: { value: number, reviewCount: number } }, availabilityData: { isActive: boolean, isAvailable: boolean, isBuyable: boolean, isInStock: boolean, availableQuantity: number }, price: { actual: { amount: number, formattedAmount: string }, discountAmount: { amount: number, formattedAmount: string }, sale: { amount: number, formattedAmount: string }, list: { amount: number, formattedAmount: string } } }>, vendor?: { id: string, name: string, rating?: { value: number, reviewCount: number } }, availabilityData: { isActive: boolean, isAvailable: boolean, isBuyable: boolean, isInStock: boolean, availableQuantity: number }, price: { discountPercent: number, actual: { amount: number, formattedAmount: string }, discountAmount: { amount: number, formattedAmount: string }, sale: { amount: number, formattedAmount: string }, list: { amount: number, formattedAmount: string } }, seoInfo: { pageTitle?: string, metaKeywords?: string, metaDescription?: string }, videos?: { items?: Array<{ name: string, thumbnailUrl: string, embedUrl?: string }> } } };
