...
export const extendedLineItemMock = {
  id: "8784ee29-8480-4966-8b18-5e7818495030",
  imageUrl: "https://vcst-dev.paas.govirto.com/cms-content/assets/catalog/7829d/35Z472/35Z472.jpg",
  inStockQuantity: 231,
  name: "Eyebolt, 1/2-13,1-3/16In, With Shoulder",
  quantity: 3,
  sku: "35Z472",
  thumbnailImageUrl: null,
  validationErrors: [],
  ...
  extended: {
    ...
    route: "/bolts/eyebolts/eyebolt-12-131-316in-with-shoulder",
    displayProperties: [
      {
        name: "Brand",
        value: "FABORY",
