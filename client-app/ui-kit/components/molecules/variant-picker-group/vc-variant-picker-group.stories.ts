...
const meta: Meta<typeof VcVariantPickerGroup> = {
  title: "Components/Molecules/VcVariantPickerGroup",
...
export const MixedTypes: StoryType = {
  args: {
    multiple: false,
    truncate: true,
    modelValue: "",
  ...
  render: (args) => ({
    setup: () => {
      ...
      const items = [
        ...
        {
          type: "text",
          value: "Commercial Professional Ultra Wide Text Option with Maximum Length",
          isAvailable: true,
        },
