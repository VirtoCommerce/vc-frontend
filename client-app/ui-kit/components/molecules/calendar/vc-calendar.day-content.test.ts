// Day-cell composition and the displayed-month contract (VCST-5732). Separate from vc-calendar.test.ts
// because that suite mocks vue-i18n module-wide, which would take createI18n with it - these tests render
// real locale messages. Same component, different harness, disjoint subjects.
